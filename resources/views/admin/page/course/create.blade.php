...
@section('content')
    ...
    <form class="flex mt-5 flex-col gap-3" method="POST" enctype="multipart/form-data" action="/admin/course">
        @method('POST')
        @csrf
        <table cellpadding="3">
            <tr>
            ...
            <tr>
                ...
                <td>
                    <textarea rows="3" class="p-2 w-80 rounded-md text-xs border border-slate-400 outline-none" type="text"
                        name="deskripsi" placeholder="Masukkan deskripsi anda" id="deskripsi"></textarea>
                </td>
            </tr>
            <tr>
                <td>
